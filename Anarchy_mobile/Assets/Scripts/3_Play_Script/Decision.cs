...
public class Decision : MonoBehaviourPun
{
    ...
    private void Start()
    {
        ...
        actionMap.Add(5, new Actions("어린이는 우리의 고려 대상이 아니다. 약탈한다.  (뉴웨이브 불가)", "약탈의 결과, 달콤한 간식거리가 가득 생겼습니다.", 13));
        actionMap.Add(6, new Actions("어린이는 나라의 새싹이다. 코묻은 식량 털어봤자 별거 없을거야. 그냥 지나간다.", "고아원 앞을 지나가다 아이들에게 공격당했습니다.", 8));
        actionMap.Add(7, new Actions("먹을것 앞에 자존심 없다, 식량을 나눠달라 한다.", "아이들은 호락호락하지 않습니다. 빈손으로 돌아가는 길은 무기력합니다.", 12));
        actionMap.Add(8, new Actions("인생의 기본은 거래다. 돈을 주고 식량을 사오자!", "약간의 식량을 얻었습니다. 아이들은 지속적인 거래를 원합니다.", 3));
        ...
        actionMap.Add(15, new Actions("목격자가 없으면 암살이다. 죽인다.", "암살에 실패했습니다. 적이 원군을 불러 곤란한 상황에 처했습니다.", 13));
        actionMap.Add(16, new Actions("이런 이득이! 생포하여 불게 만든다.", "앗 이런, 사람을 잘못보았습니다. 아무것도 모르는 민간인을 생포했습니다. 그는 정신적 피해보상을 요구합니다.", 10));
        actionMap.Add(17, new Actions("동료는 많을수록 좋다. 회유하여 우리편으로 끌어온다.", "바보같은 생각이었습니다. 불필요한 싸움으로 번져 정찰에 필요한 시간이 낭비되었습니다.", 6));
        ...
        actionMap.Add(21, new Actions("저런건 다 사기다. 무시한다.", "빠른 결정과 통찰은 언제나 바른 결과를 불러옵니다.", 13));
        actionMap.Add(22, new Actions("두드리면 나올거다, 자판기를 부순다.", "이거 방탄 자판기야..!라고 누군가 소리치는것 같습니다. 손이 아픕니다.", 14));
        actionMap.Add(23, new Actions("내돈으로 하기는 아깝다. 남는 동전 없나? 자판기 밑을 뒤져본다.", "동전은 찾았지만 왜인지 씁쓸함을 느낍니다. 더 이상 자판기의 내용물이 궁금하지 않습니다.", 2));
        actionMap.Add(24, new Actions("내용물이 궁금하다. 동료를 부추겨본다.", "동료가 뽑은 박스의 안에는 작고 귀여운 100원짜리가 들어있었습니다. 이것이 진정한 랜덤입니다.", 14));
        ...
        actionMap.Add(28, new Actions("이상한 사람이다. 무시한다.", "돌이켜 생각해보니 괜히 손해본 기분이 듭니다. 왜일까요.", 10));
        ...
        actionMap.Add(37, new Actions("마침 좋은 제안이다. 병력을 끌고 회담에 나간다.", "상대도 역시 병력을 이끌고 왔습니다. 각자의 병력에 손실을 입었습니다.", 4));
        actionMap.Add(38, new Actions("승낙한다. 날짜는 4/31일로 전달한다.", "적이 모욕을 당했다며 세력을 끌고 왔습니다. 전면전입니다.", 1));
        actionMap.Add(39, new Actions("승낙한다. 최소한의 인원만을 데리고 회남에 나간다.", "서로에게 매우 유익한 시간이었습니다. 두 세력은 이제 영원한 앙숙입니다.", 1));
        actionMap.Add(40, new Actions("당장 산다(소사이어티, 마법사 불가)", "성분을 알 수 없는 시리얼을 먹다가 배탈이 났습니다.", 14));
        ...
        actionMap.Add(45, new Actions("지금이 기회다. 적을 급습한다. (뉴웨이브, 마피아 불가)", "공격에 성공했습니다. 적에게 큰 피해를 입혔습니다.", 11));
        ...
        actionMap.Add(56, new Actions("일단 사용해본다. 이게 되겠어?", "이게 되네..? 중요한 아이템이 날아갔습니다.", 14));
        actionMap.Add(57, new Actions("전투에 즉각 활용해봅니다.", "투명인간은 정말 최고입니다. 적의 영토를 손쉽게 점령하였습니다.", 11));
        ...
        actionMap.Add(62, new Actions("기습에 전면으로 맞설 필요는 없습니다. 물자창고만을 중점적으로 지킵니다.", "적들은 기습을 핑계로한 약탈을 목적으로 왔던 것이었습니다. 성공적으로 막아내었습니다.", 5));
        actionMap.Add(63, new Actions("기지를 비우고 우리도 기습을 가자!", "정보가 잘못되었나봅니다. 적은 오지 않았고, 우리의 기습은 실패하였습니다.", 12));
        actionMap.Add(64, new Actions("우왕좌왕 어떻게 할지 고민하다가 기습 예정일이 되었다.", "잘못된 정보였던 것 같습니다. 아무일도 일어나지 않았습니다.", 15));
        actionMap.Add(65, new Actions("적당한 긴장감은 작전수행에 도움이된다.", "적당하지않았나봅니다. 지나친 긴장은실수를 불러옵니다.", 8));
        actionMap.Add(66, new Actions("동료들과 스몰토크로 긴장감을 풀어본다.", "이야기에 정신이팔려 정작 중요한걸 잊어버렸습니다.", 4));
        actionMap.Add(67, new Actions("청심환을 먹는다.", "너무 나른해진 나머지 작전 도중 찾아오는 졸음을 이기지 못했습니다.", 14));
        actionMap.Add(68, new Actions("아 모르겠다. 너무너무너무너무 긴장된다.", "짓누르는 긴장감을 이기지 못하고 작전을 포기해버렸습니다.", 2));
        actionMap.Add(69, new Actions("동료들과 함께라면 괜찮을거야!", "작전에 성공했습니다. 동료들과 함께라면 못할것이 없습니다.", 9));
        actionMap.Add(70, new Actions("세상을 바꿀 대업을 위해 힘쓰고있다. 무시한다.", "꼭 연락달라며 명함을 받았습니다. 허접한 디자인에 유명 기획사의 이름이적혀있습니다.", 15));
        actionMap.Add(71, new Actions("자세한 얘기를 들어본다.", "들을수록 솔깃하다. 난 스타가 될거야...! 정찰에 실패하였습니다.", 6));
        actionMap.Add(72, new Actions("나는 못생겼다. 내게 그런 제의가 올리 없다.", "정찰에서 좋은 소득을 얻었습니다. 왜인지 씁쓸합니다.", 4));
        actionMap.Add(73, new Actions("연예인은 극한직업이다. 관심없다고 대답한다.", "유명인의 부와 명예에 관해 얘기하며끈질기게 따라붙습니다. 결국 정찰은 커녕 시간낭비만했습니다.", 8));
        actionMap.Add(74, new Actions("연예인을 향한 여정을 시작한다.자 이제시작이야!", "연습생 생활은 고달픕니다. 언제쯤 데뷔할 수 있을까요?", 10));
    }
